...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='ESMStereo_trt')
    parser.add_argument('--model', default='ESMStereo_trt', help='select a model structure', choices=__models__.keys())
    ...
    model=__models__["ESMStereo_trt"](MAXDISP, gwc, norm_correlation, args.backbone, args.cv_scale)
