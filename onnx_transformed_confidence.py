...
if __name__ == "__main__":
    ...
    onnx = torch.onnx.export(model.module, args=(left, right), f="StereoModelConf.onnx", input_names=["left", "right"], output_names=["disp", "confidence"], verbose=True, do_constant_folding=False)
